 ...
 * @author Michael
 */
public class DaoImpl extends AbstractModel {

    private Logger logger = Logger.getLogger(DaoImpl.class);

    @Override
    public String getTemplateContent() {
        String templateFile = "/template/server/dao.impl.ftl";
        try {
    ...
    public String getFullPath() {
        ...
        String path = StringUtils.addSuffix(root, "/") + "eccrm-" + module + "/" + module + "-impl/src/main/java/" + packageName.replaceAll("\\.", "/") + "/dao/impl/" + getFileName();
        return path;
    }

    @Override
    public String getFileName() {
        return BuildContext.get(BuildContext.ENTITY_NAME) + "DaoImpl.java";
    }
