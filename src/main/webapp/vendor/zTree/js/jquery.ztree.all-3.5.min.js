...
(function (p) {
    ...
    var j = {apply: function (b, a, c) {
        ...
        if (a)a.isAjaxing = !0, k(a, e.id.ICON, b).attr({style: "", "class": e.entity.BUTTON + " " + e.entity.ICO_LOADING});
        var l = {};
        ...
        b.push("<li id='", c.tId, "' class='", e.entity.LEVEL, c.level, "' tabindex='0' hidefocus='true' treenode>")
        ...
        b.push("<a id='",
            c.tId, e.id.A, "' class='", e.entity.LEVEL, c.level, "' treeNode", e.id.A, ' onclick="', c.click || "", '" ', f != null && f.length > 0 ? "href='" + f + "'" : "", " target='", i.makeNodeTarget(c), "' style='", l.join(""), "'");
        ...
        return e.entity.BUTTON + " " + c.join("_")
        ...
        return e.entity.BUTTON + " " + e.entity.LEVEL + b.level + " " + e.entity.SWITCH + " "
        ...
        makeNodeUrl: function (b, a) {
            ...
            c.push("<ul id='", a.tId, e.id.UL, "' class='", e.entity.LEVEL, a.level, " ", i.makeUlLineClass(b, a), "' style='display:", a.open ? "block" : "none", "'>");
            c.push(d);
            c.push("</ul>")
    ...
    p.fn.zTree = {consts: {entity: {BUTTON: "button", LEVEL: "level", ICO_LOADING: "ico_loading", SWITCH: "switch"}, event: {NODECREATED: "ztree_nodeCreated", CLICK: "ztree_click", EXPAND: "ztree_expand", COLLAPSE: "ztree_collapse", ASYNC_SUCCESS: "ztree_async_success", ASYNC_ERROR: "ztree_async_error"}, id: {A: "_a", ICON: "_ico", SPAN: "_span", SWITCH: "_switch", UL: "_ul"}, line: {ROOT: "root",
...
(function (m) {
    ...
    m.extend(!0, m.fn.zTree._z, {tools: {}, view: {checkNodeRelation: function (b, a) {
        ...
        return j.entity.BUTTON + " " + d.DEFAULT + " " + c
...
(function (w) {
    ...
    w.extend(!0, w.fn.zTree._z, {tools: {getAbs: function (b) {
        ...
        if (!(a.editNameFlag || p(a, d.id.EDIT, b).length > 0) && g.apply(b.edit.showRenameBtn, [b.treeId, a], b.edit.showRenameBtn)) {
            var c = p(a, d.id.A,
                b), l = "<span class='" + d.entity.BUTTON + " edit' id='" + a.tId + d.id.EDIT + "' title='" + g.apply(b.edit.renameTitle, [b.treeId, a], b.edit.renameTitle) + "' treeNode" + d.id.EDIT + " style='display:none;'></span>";
            c.append(l);
        ...
        if (!(a.editNameFlag || p(a, d.id.REMOVE, b).length > 0) && g.apply(b.edit.showRemoveBtn, [b.treeId, a], b.edit.showRemoveBtn)) {
            var c =
                p(a, d.id.A, b), l = "<span class='" + d.entity.BUTTON + " remove' id='" + a.tId + d.id.REMOVE + "' title='" + g.apply(b.edit.removeTitle, [b.treeId, a], b.edit.removeTitle) + "' treeNode" + d.id.REMOVE + " style='display:none;'></span>";
            c.append(l);
        ...
        if (c !== a.level) {
            var e = p(a, b), g = p(a, d.id.A, b), b = p(a, d.id.UL, b), c = d.entity.LEVEL + c, a = d.entity.LEVEL + a.level;
            e.removeClass(c);
            e.addClass(a);
            g.removeClass(c);
            g.addClass(a);
