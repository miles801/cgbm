...
<body >
<div class="main <#if listPage.conditionRows??>condition-row-<#if listPage.conditionRows &gt; 3 >3<#else>${listPage.conditionRows}</#if></#if>" ng-app="eccrm.${name}.${className}.list" ng-controller="${className}ListController" >
                ...
                <#if listPage.tableHeaderText?? || listPage.tableHeaderButtons??>
                    ...
                    <div class="table-responsive panel panel-table" >
                        <table class="table table-striped table-hover" >
                            ...
                            <tr ng-show="!${className}s || !${className}s.data || ${className}s.data.length == 0" >
                            <#if listPage.allowCheckbox! = true>
...
<script type="text/javascript" src="app/${path}/list/${className}_list.js" ></script >
